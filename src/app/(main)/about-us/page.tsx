  ...
  return (
    <div className="h-auto min-h-screen w-screen bg-[#f3b700] flex justify-center items-center flex-col">
      ...
      <p className="text-2xl text-[#fbf7ec] px-16 pb-16">
        ...
        adventure, or a cultural exploration, our immersive virtual vacations
        transport you to extraordinary destinations. Founded during the
        challenging times of COVID-19, we strive to make exploration accessible
        to everyone, everywhere. Our expert team crafts each experience to be
        visually stunning and emotionally engaging, providing a true sense of
